...
def test_linear_classifier_with_features(dataFun, learner, feature_fun,
    ...
    if hook: hook((th, th0))
    print("Final score", float(score(data, labels, th, th0)))
...
test_with_features(super_simple_separable_through_origin, 1, draw=False, pause=False)
test_with_features(super_simple_separable, 1, draw=False, pause=False)
test_with_features(xor, 2, draw=False, pause=False)
